...
import pizza.asmae.ma.pizzarecipes.adapter.ProduitAdapter;
import pizza.asmae.ma.pizzarecipes.classes.Produit;
import pizza.asmae.ma.pizzarecipes.service.ProduitSercive;

public class ListPizzaActivity extends AppCompatActivity {
    private ProduitSercive ps=new ProduitSercive();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (produits == null) {
            produits = new ArrayList<>(); // Créez une liste vide si null
        }
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Intent vers PizzaDetailActivity
                Intent intent = new Intent(ListPizzaActivity.this, PizzaRecipe.class);
